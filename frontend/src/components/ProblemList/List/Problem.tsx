...
const Problem = ({ problemId }: ProblemProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  bg-sublime-dark-grey-blue py-20">
      ...
      <div className="flex flex-col items-center w-full max-w-screen-md space-y-5 mt-5">
        <input
          type="text"
        ...
        <button
          ...
          className="w-full h-12 text-base sm:text-lg font-bold text-black bg-white rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50"
        >
          방 참가하기
        </button>
        <button
